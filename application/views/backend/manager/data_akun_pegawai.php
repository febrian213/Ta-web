...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            <form class="data" method="post" action="<?= site_url('backend/manager/data_akun_pegawai/delete') ?>">
                <table id="table">
                    <tr>
                        <td></td>
                        <td>Usernme</td>
                ...
                <div class="action">
                    ...
                    <a href="<?php echo site_url('backend/manager/data_akun_pegawai/viewInsert') ?>"><input type="button" value="Tambah Akun"></a>
                </div>
            </form>
        </div>
