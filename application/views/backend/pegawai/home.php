...
<body>
    ...
    <div class="container">
        <nav class="top">
            <span class="right">
                <form method="post" action="<?php print site_url();?>/backend/pegawai/home/search" enctype="multipart/form-data">
        ...
        <div class="content">
            <table>
                ...
                <tr>
                    ...
                    <td><a href="<?php echo site_url('backend/pegawai/home/update/'.$row->id_pemesan) ?>">Edit</a></td>
                </tr>
                <?php endforeach; ?>
            </table>
            <div class="msgfalse">
            ...
            <div class="btn">
                <button class="btn-input"><a href="<?php echo site_url('backend/pegawai/input') ?>">Input pemesan</a></button>
                <button class="btn-tampil"><a href="<?php echo site_url('backend/pegawai/home') ?>">Tampilkan semua data</a></button>
            </div>
        </div>
